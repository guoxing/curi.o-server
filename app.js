...
app.post('/api/estimate-active-time', logBrowse.logEstimateAT);
app.post('/api/estimate-visit-times', logBrowse.logEstimateVT);
app.get('/api/user-responses', logBrowse.getUserResponses);
